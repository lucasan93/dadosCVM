...
The goal of dadosCVM is to obtain data of investments funds registered on Comissão de Valores Mobiliários (_Security and Exchange Commissions from Brazil_). Data is collected from files available at http://dados.cvm.gov.br/dados/. 

Main goals/ideas are descripted below:

  - cad_fi(): Download the latest Registration Data ('Dados Cadastrais') available on CVM - 100%;
