...
Main goals/ideas are descripted below:
  ...
  - cad_fi(): Download the latest Registration Data ('Dados Cadastrais') available on CVM at  - 100%;
  - fidc(): Develop a function that downloads monthly FIDC data between two dates from a selected table of the FIDC files located at http://dados.cvm.gov.br/dados/FIDC/DOC/INF_MENSAL/DADOS/;
