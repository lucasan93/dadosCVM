...
And in order to verify how the segments and its items are organized based on their CVM categories, take a look at the _defs_fidc_ database within the package. **Note that the observations in which item == 'total' are excluded when running the _dados_fidc()_ function in order to avoid double counting.**
